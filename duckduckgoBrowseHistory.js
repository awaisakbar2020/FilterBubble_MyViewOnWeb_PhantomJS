 ...
 * by: Awais Akbar
 * 
 * Goal: Takes a list of urls, and browses them one by one!
 * 
 * optional flags:
 *
 *    --clear_cookies:clears cookies after each query, DEFAULT: No (won't clear cookies)
 *    --depth_limit:  depth of clicks within a domain before going to the next url
 *    --page_limit:   number of clicks within a domain before going to the next url
